<x-show>
    <div class="bg-white font-sans leading-normal tracking-normal">
                ...
                <div class="flex flex-wrap items-center content-center">
                    <div class="flex w-1/2 justify-start text-white font-extrabold">
                        <a class="flex text-gray-900 no-underline hover:text-gray-900 hover:no-underline pl-2" href="#">
                            👻 <span class="hidden w-0 md:w-auto md:block pl-1">Blog Daniel</span>
                        </a>
                    </div>
                    <div class="flex w-1/2 justify-end content-center">
                        ...
                        <a class="inline-block text-white no-underline hover:text-white hover:text-underline text-center h-10 w-10 p-2 md:h-auto md:w-16 md:p-4"
                            href="https://twitter.com/intent/tweet?url={{ route('posts.show', $post) }}" style="background-color:#33b1ff;">
        ...
        <div class="text-center pt-16 md:pt-32">
            <p class="text-sm md:text-base text-green-500 font-bold">{{ $post->created_at->toFormattedDateString() }}
            </p>
            <h1 class="font-bold break-normal text-3xl md:text-5xl">{{ $post->name }}</h1>
        </div>

        <!--image-->
        <div class="container w-full max-w-6xl mx-auto bg-white bg-cover mt-8 rounded sm:px-16 " style="background-image:url('@if($post->image){{ Storage::url($post->image->url) }}@else https://cdn.pixabay.com/photo/2022/01/26/05/56/stairs-6968125_960_720.jpg @endif'); height: 75vh;"></div>
        ...
        <div class="container max-w-5xl mx-auto -mt-32">
            ...
            <div class="mx-0 sm:mx-6">
                ...
                <div class="bg-white w-full p-8 md:p-24 text-xl md:text-2xl text-gray-800 leading-normal"
                    ...
                    <p class="text-2xl md:text-3xl mb-5">
                        👋 Welcome fellow <a
                            ...
                            href="https://www.tailwindcss.com">{{ $post->extract }}
                        </a>
                    </p>
                ...
                <div class="container font-sans bg-green-100 rounded mt-8 p-4 md:p-24 text-center">
                    ...
                    <h3 class="font-bold break-normal  text-gray-600 text-base md:text-xl">Get the latest
                        posts
                ...
                <div class="flex w-full items-center font-sans p-8 md:p-24">
                    ...
                    <div class="flex-1">
                        <p class=" font-bold text-base md:text-xl leading-none">Blog Dainel</p>
                        <p class="text-gray-600 text-xs md:text-base">Puedes contactarnos a traves del correo <a
                                class="text-gray-800 hover:text-green-500 no-underline border-b-2 border-green-500"
                                href="https://www.tailwindtoolbox.com">daniel@gmail.com</a></p>
                    </div>
                    <div class="justify-end">
                        <a href="{{ route('posts.index') }}"
                            class="bg-transparent border border-gray-500 hover:border-green-500 text-xs text-gray-500 hover:text-green-500 font-bold py-2 px-4 rounded-full">Leer más
                        </a>
                    </div>
                </div>
                <!--/Author-->
